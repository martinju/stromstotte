...
# 3 [forecast.R] load model and daily data and use these to forecast the rest of the month, compute compensation and save current estimated compensation to file
# 4 [viz_compensation.R] plot histogram/density of every area + next day's price

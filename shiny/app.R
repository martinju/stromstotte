...
body_strompris_naa <- tabItem(tabName = "strompris_naa",
                              fluidPage(
                                ...
                                p("Fra 1.september 2023 endres regjeringens strømstøtteordning til å kompensere den til enhver tid ",
                                  "gjeldende spotprisen istedet for gjennomsnittlig månedelig spotpris. Estimeringsmetoden som dannet grunnlaget for denne siden",
                                  "blir unødvendig. Nettsiden vil fortsette å tilby totaloversikt over spotpris, strømstøtte og nettleie." ,
